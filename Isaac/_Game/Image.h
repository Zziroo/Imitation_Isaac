...
public:
	...
	void			DamagedBossMonsterHP(HDC hdc, int destX, int destY, float HP);
	...
	void			TransparentRender(HDC hdc, int destX, int destY, int frameX, int frameY, float transparency = 255.0f);								// 이미지를 투명화 처리
